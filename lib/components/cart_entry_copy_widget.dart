...
import 'cart_entry_copy_model.dart';
export 'cart_entry_copy_model.dart';

class CartEntryCopyWidget extends StatefulWidget {
  const CartEntryCopyWidget({
    Key? key,
    this.productName,
    this.productPrice,
    this.productImage,
  ...
  @override
  _CartEntryCopyWidgetState createState() => _CartEntryCopyWidgetState();
}

class _CartEntryCopyWidgetState extends State<CartEntryCopyWidget> {
  late CartEntryCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartEntryCopyModel());
  }
                          ...
                          'Total Price ${valueOrDefault<String>(
                            formatNumber(
                              functions.calItemPrice(
                                  widget.unitPrice!, widget.productQty!),
